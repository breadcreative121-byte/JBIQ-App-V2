    ...
    cards: [
      {
        ...
        tags: ['Mumbai', 'Live TV + JioHotstar'],
        badge: 'Live',
...
const MOCK_RECHARGE_299 = {
  ...
  collection: {
    ...
    rows: [
      ...
      },
      {
        ...
        values: [
          { option_id: 'jio',    display: 'JioHotstar Premium', emphasis: 'best' },
  ...
  voice_disclosure: "3 plans at ₹299 for 28 days. Jio gives the most — 2 GB a day, unlimited calls, JioHotstar Premium. Airtel and Vi offer 1.5 GB with smaller OTT perks. On screen — tap Jio, or compare side by side?",
  meta: {
    intent: 'discover',
...
const MOCK_RECHARGE_299_SINGLE = {
    ...
    cards: [
      {
        ...
        status_label: 'JioHotstar Premium included',
        badge: 'Best value',
        tags: ['2GB/day', 'Unlimited', 'JioHotstar'],
  ...
  voice_disclosure: "₹299 plan mil gaya — 28 din validity, 2GB rozaana, unlimited calls, JioHotstar premium. Confirm karein? On screen — Confirm & Pay tap karein.",
  suggested_prompts: [
